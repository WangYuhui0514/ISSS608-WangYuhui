...
### **5.4.1 Removing header and automated email signitures**
...
### **5.4.2 Removing lines with nested text representing quotes from other users.**
...
### **5.4.4 Visualising Words in newsgroups**
...
### **5.4.5 Visualising Words in newsgroups**
...
### **5.5.1 Computing tf-idf within newsgroups**
...
### **5.5.2 Visualising tf-idf as interactive table**
...
### **5.5.3 Visualising tf-idf within newsgroups**
...
### **5.5.4 Counting and correlating pairs of words with the widyr package**
...
### **5.5.5 Visualising correlation as a network**
...
### **5.5.7 Create a network graph from bigram data frame**
...
### **5.5.8 Visualizing a network of bigrams with ggraph**
